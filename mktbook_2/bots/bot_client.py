"""Per-student Discord bot client for mktbook_2."""
...
# Reuse conversation builder and DB from the main mktbook package
from mktbook.bots.conversation import build_reply_messages
from mktbook import db
...
class SingleBot(discord.Client):
    """A Discord client for one student's bot (mktbook_2)."""
    ...
    async def on_ready(self) -> None:
        log.info("mktbook_2 Bot %s (%s) is online", self.bot_row.bot_name, self.user)
