"""Manages the fleet of Discord bot clients for mktbook_3."""
...
class BotFleet:
    """Manages all active Discord bot instances (mktbook_3)."""
    ...
    async def start_bot(self, bot_row: Bot) -> None:
        ...
        log.info("Launched mktbook_3 bot %s (id=%d)", bot_row.bot_name, bot_row.id)
