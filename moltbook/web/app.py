...
def create_app(ws: WSManager) -> FastAPI:
    app = FastAPI(title="MoltBook Bot Marketplace")
    ...
    # Register routes
    from moltbook.web.routes_api import router as api_router
    from moltbook.web.routes_pages import router as pages_router
