// MoltBook WebSocket client for live dashboard updates
...
(function() {
    ...
    function connect() {
        ...
        ws.onopen = function() {
            console.log('MoltBook WS connected');
            reconnectDelay = 1000;
        };
        ...
        ws.onclose = function() {
            console.log('MoltBook WS disconnected, reconnecting in', reconnectDelay, 'ms');
            setTimeout(connect, reconnectDelay);
            reconnectDelay = Math.min(reconnectDelay * 2, 30000);
        };

        ws.onerror = function(err) {
            console.error('MoltBook WS error', err);
        };
    }
